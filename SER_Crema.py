...
def dataset_discription(fold, dataset="crema"):
    ...
    test_dict = {}
    if dataset == "crema":
        fold_path = "/home/mhm/Downloads/crema/wav/federated_learning/emobase/emotion/crema-d/"
    elif dataset == "iemocap":
        fold_path = "/home/mhm/Downloads/iemocap/wav/federated_learning/emobase/emotion/iemocap/"
    elif dataset == "mel":
        fold_path = "/home/mhm/Downloads/crema/wav/federated_learning/mel/emotion/crema-d/"
...
def prepare_dataloaders_per_speaker(i, features = "crema"):
    train_clients_data, test_clients_data = dataset_discription(i, features)
    ...
    return x_test, y_test, train_loaders, global_testloader, global_testset, trainsets, num_client, num_data_per_client, distributed_clients
...
def federated(distribution="equal", modelType="non-DP", features="crema"):
    ...
    for fold in range(3, 4):
        X_test, y_test, trainloaders, global_testloader, global_testset, \
        ...
        for epoch in range(200):
            ...
            losses.append(valid_loss / len(global_testloader))
